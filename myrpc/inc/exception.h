//
// msgpack::myrpc::exception - MessagePack-RPC for C++
//
...
//
#ifndef MSGPACK_MYRPC_EXCEPTION_H
#define MSGPACK_MYRPC_EXCEPTION_H
...
struct remote_error : call_error {
	remote_error () :
		call_error("remote error") {}
...
#endif // MSGPACK_MYRPC_EXCEPTION_H
